...
const CaptiveSignsMail_1 = require("./CaptiveSignsMail");
let mailOpts = {
        ...
        async.series([
            ...
            function (step) {
                ...
                if (useOAuth2forGMail) {
                    CaptiveSignsMail_1.sendOauth2Mail({ subject: mailOpts.Subject, from: mailOpts.From, to: mailOpts.To, text: mailOpts.Text });
                }
                else {
                    CaptiveSignsMail_1.sendSMTPMail({ subject: mailOpts.Subject, from: mailOpts.From, to: mailOpts.To, text: mailOpts.Text });
                }
            },
            ...
            function (step) {
                ...
                trelloapi.addCard('Change Request (' + trello.name + ') ( via appsheet)', trello.description, lesSchwabListId, function (error, trelloCard) {
                    if (error) {
