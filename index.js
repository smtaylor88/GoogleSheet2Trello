    ...
    function GSheetData() {
        async.series([
            ...
            function(step) {
                ...
                mymail.createCaptiveSignsMail({ useOAuth2: "true", mailmessage: "logged on!" });
            },
            ...
            function(step) {
                ...
                sheet.getRows({query: 'totrello=""'}, function( err, rows ){
                    if( rows.length > 0 ) {
                        ...
                        var msg = "No change requests to process! (" + new Date() + ")";
                        mymail.createCaptiveSignsMail({ useOAuth2: "true", mailmessage: "No change requests to process! (" + new Date() + ")" });
